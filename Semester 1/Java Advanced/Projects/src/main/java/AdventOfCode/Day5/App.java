    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n.length; i++) {
            if (n[i] == 99) {
                ...
                n[n[i + 1]] = scanner.nextInt();
            } else if (n[i] == 4) {
                System.out.println(n[n[i + 1]]);
            } else {
                String strNumber = "" + n[i];
                int m1 = Integer.parseInt(strNumber.substring(0, 1));
                int m2 = Integer.parseInt(strNumber.substring(1, 2));
                int m3 = Integer.parseInt(strNumber.substring(2, 3));
                int opCode = Integer.parseInt(strNumber.substring(2, 4));
            }
            if (n[i] == 3 || n[i] == 4) {
                i += 1;
            } else {
