...
namespace Exercise2
{
    public partial class MainWindow : Window
    {
        ...
        public IList<Game> Games { get => games; set => games = value; }

        private IList<Game> CreateGames()
        {
            games = new List<Game>
            {
                new Game
        ...
        {
            DataContext = ((ComboBox)sender).SelectedItem;
        }

        private void RateUpButton_Click(object sender, RoutedEventArgs e)
        {
            ((Game)gamesCombobox.SelectedItem).Rating += 0.1;
        }
